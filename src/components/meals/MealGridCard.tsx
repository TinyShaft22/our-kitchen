...
export function MealGridCard({ meal, onSelect }: MealGridCardProps) {
  return (
    <button
      ...
      className="w-full rounded-soft overflow-hidden shadow-soft hover:shadow-lifted transition-all duration-200 group focus:outline-none focus:ring-2 focus:ring-terracotta focus:ring-offset-2 bg-cream"
